...
<!-- End Topbar -->
	...
	<!-- End title  -->
				...
				<h3><a href="admin_check_appt.php?doctor=harshil&department=Child care"><strong>Dr. Harshil Patel</strong></a></h3>
				<h4>/ Consultant</h4>
				<p>Child care</p>
				</li>
				<li class="col-sm-3 col-xs-6 " style="margin-bottom: 30px;">
				...
				<h3><a href="admin_check_appt.php?doctor=Ahmed&department=Neurology"><strong>Dr. Ahmed Shaikh</strong></a></h3>
				<h4>/ MBBS</h4>
				<p>Neurology</p>
				</li>
				...
				<h3><a href="admin_check_appt.php?doctor=Naeem&department=General Surgery"><Strong>Dr. Naeem</Strong></a></h3>
				<h4>/ MBBS, MS, DNB</h4>
				<p>General Surgery</p>
				</li>
				...
				<h3><a href="admin_check_appt.php?doctor=Dua&department=Health Checkup"><strong>Dr. Dua</strong></a></h3>
				<h4>/ MBBS</h4>
				<p>Health Checkup</p>
				</li>
				</ul>
				...
				<h3><a href="admin_check_appt.php?doctor=Aslam&department=Dermatology"><strong>Dr. Aslam Jamali</strong></a></h3>
				<h4>/ MD</h4>
				<p>Dermatology</p>
				</li>
				<li class="col-sm-3 col-xs-6 " style="margin-bottom: 30px;">
				...
				<h3><a href="admin_check_appt.php?doctor=Salman&department=Eye Specialist"><strong>Dr. Salman khan</strong></a></h3>
				<h4>/ MBBS,MS, MD</h4>
				<p>Eye Specialist</p>
				</li>
				<li class="col-sm-3 col-xs-6">
				...
				<h3><a href="admin_check_appt.php?doctor=Imran&department=CCU & ICU"><strong>Dr. Imran Laghari</strong></a></h3>
				<h4>/ MBBS</h4>
				<p>CCU & ICU</p>
				</li>
				...
				<h3><a href="admin_check_appt.php?doctor=Jamel&department=Cardiology">Dr. Jamel</a></h3>
				<h4>/ MBBS</h4>
				<p>Cardiology</p>
				</li>
				</ul>
